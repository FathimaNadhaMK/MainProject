...
export default function RoadmapView({ roadmap, achievementData }) {
    ...
    return (
        <div className="space-y-10 pb-20">
            ...
            <Tabs defaultValue="roadmap" className="space-y-10">
                <TabsList className="bg-white/5 border border-white/10 p-1 h-14 rounded-2xl w-full max-w-2xl mx-auto grid grid-cols-2">
                    <TabsTrigger
                        value="roadmap"
                        className="rounded-xl data-[state=active]:bg-blue-600 data-[state=active]:text-white font-bold transition-all"
                    >
                        Journey Path
                    </TabsTrigger>
                    <TabsTrigger
                ...
                <TabsContent value="roadmap" className="space-y-10 outline-none">
                ...
                <TabsContent value="evaluations" className="outline-none">
                    <section className="space-y-6">
                        <div className="flex flex-col gap-2">
                            <h3 className="text-2xl font-bold text-white tracking-tight">Project Evaluation History</h3>
                            <p className="text-gray-400">Review your past performance and mentor feedback across all submitted projects.</p>
                        </div>
                        <EvaluationHistory />
                    </section>
                </TabsContent>
