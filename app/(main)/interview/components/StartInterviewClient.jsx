      ...
      <div className="max-w-5xl w-full space-y-12 relative z-10 animate-in fade-in zoom-in-95 duration-1000 py-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
              ...
              <section className="space-y-6">
                ...
                <div
                  ...
                  className={`relative group border-2 border-dashed rounded-[3rem] p-10 text-center cursor-pointer transition-all duration-700 bg-white/[0.03] backdrop-blur-3xl overflow-hidden ${
                    dragActive 
                ...
                >
                  ...
                  <div className="space-y-4">
                    <div className={`w-16 h-16 mx-auto rounded-2xl flex items-center justify-center transition-all duration-500 ${
                      resumeFile ? "bg-emerald-500 text-white shadow-[0_0_30px_rgba(16,185,129,0.3)]" : "bg-white/5 text-slate-400 group-hover:text-white group-hover:bg-indigo-500"
                    }`}>
                      {resumeFile ? '✓' : '+'}
                    </div>
                    {resumeFile ? (
                ...
                <div className="grid grid-cols-2 gap-4">
                  {[
                    ...
                    <button
                      ...
                      className={`relative p-8 rounded-3xl flex flex-col items-center gap-4 transition-all duration-500 border-2 ${
                        mode === option.key
                ...
                <div className="grid grid-cols-3 gap-4">
                  {[
                    ...
                    <button
                      ...
                      className={`relative p-6 rounded-3xl flex flex-col items-center justify-center gap-2 transition-all duration-500 border-2 ${
                        duration === option.key
                          ? "border-indigo-500 bg-indigo-500/10 shadow-[0_0_40px_rgba(99,102,241,0.2)] scale-[1.05]"
                          : "border-white/5 bg-white/[0.03] hover:border-white/20"
                      }`}
                ...
                {contextLoading ? (
                  ...
                  recruiters.map((r) => (
                    <div
                      ...
                      className={`group cursor-pointer relative p-6 rounded-[2rem] transition-all duration-500 border-2 overflow-hidden ${
                      ...
                      <div className="flex items-center gap-5 relative z-10">
                        <div className="relative">
                          <img 
                            src={r.avatar} 
                            alt={r.name} 
                            className={`w-14 h-14 rounded-2xl object-cover transition-all duration-700 grayscale ${
                              selectedRecruiter?.id === r.id ? "scale-110 grayscale-0" : "opacity-40 group-hover:grayscale-0 group-hover:opacity-100"
                            }`} 
                          />
                          {selectedRecruiter?.id === r.id && (
        ...
        <div className="pt-12 text-center">
          ...
          >
            ...
            <div className={`relative px-12 py-6 rounded-full font-black text-xs uppercase tracking-[0.5em] transition-all duration-500 ${
              loading ? "bg-slate-800 text-slate-500" : "bg-white text-black hover:bg-indigo-400 hover:text-white"
            }`}>
